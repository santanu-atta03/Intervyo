    ...
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <section className="pt-40 pb-20 px-6 relative overflow-hidden bg-gray-950">
        ...
        <div
          ...
          style={{ animation: "sweepGlow 8s ease-in-out infinite 0.5s" }}
        />
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-3xl mx-auto">
            Start free, upgrade when you're ready. All plans include AI-powered
            feedback
            <br />
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            <span
              className={`text-lg font-medium ${billingCycle === "monthly" ? "text-white" : "text-gray-500"}`}
            >
              Monthly
            </span>
            <button
            ...
            >
              <div
                className={`absolute top-1 left-1 w-6 h-6 bg-emerald-500 rounded-full transition-transform ${billingCycle === "yearly" ? "translate-x-8" : ""}`}
              />
            </button>
            <span
              className={`text-lg font-medium ${billingCycle === "yearly" ? "text-white" : "text-gray-500"}`}
            >
              Yearly{" "}
              <span className="text-emerald-500 text-sm">(Save 20%)</span>
            </span>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white group-hover:bg-gray-900 rounded-2xl p-10 shadow-2xl border-4 border-gray-900 flex flex-col hover:scale-105 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gray-900 group-hover:bg-white rounded-xl flex items-center justify-center transition-colors duration-300">
                  <Zap className="w-6 h-6 text-white group-hover:text-gray-900 transition-colors duration-300" />
                </div>
                <h3 className="text-4xl font-bold text-gray-900 group-hover:text-white transition-colors">
                  Free
                </h3>
              </div>

              <p className="text-gray-600 group-hover:text-white text-lg mb-8 pb-6 border-b border-gray-300 group-hover:border-gray-600 transition-colors">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-500 group-hover:text-white text-lg mt-2 transition-colors duration-300">
                  Forever free
                </p>
              </div>
              ...
              <div className="space-y-4 mb-10 flex-grow">
                <div className="flex items-start gap-3">
                  <Check
                    className="w-5 h-5 text-emerald-500 group-hover:text-emerald-300 flex-shrink-0 mt-1 transition-colors duration-300"
                    strokeWidth={3}
                  />
                  <p className="text-gray-700 group-hover:text-white text-base transition-colors">
                    2 AI-powered interviews per month
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Check
              ...
              <button
                ...
                className="w-full py-4 bg-gray-900 hover:bg-gray-800 text-white font-bold text-lg rounded-xl transition-colors mt-auto"
              >
                Get Started Free
              </button>
            </div>
            ...
            <div className="group bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-10 shadow-2xl border-4 border-emerald-400 relative flex flex-col hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-emerald-50 group-hover:text-white text-lg mb-8 pb-6 border-b border-emerald-400 transition-colors">
              ...
              <div className="mb-8">
                ...
                <p className="text-emerald-100 group-hover:text-white text-lg mt-2 transition-colors duration-300">
                  per month, billed {billingCycle}
                </p>
                {billingCycle === "yearly" && (
                  <p className="text-yellow-300 group-hover:text-white text-sm mt-1 font-semibold transition-colors">
                    Save ₹2,400/year
                  </p>
                )}
              </div>
              ...
              <p className="text-emerald-100 group-hover:text-white text-sm text-center mt-3 transition-colors">
            ...
            <div className="group bg-white group-hover:bg-gray-900 rounded-2xl p-10 shadow-2xl border-4 border-gray-900 flex flex-col hover:scale-105 transition-all duration-300">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gray-900 group-hover:bg-white rounded-xl flex items-center justify-center transition-colors duration-300">
                  <Building2 className="w-6 h-6 text-white group-hover:text-gray-900 transition-colors duration-300" />
                </div>
                <h3 className="text-4xl font-bold text-gray-900 group-hover:text-white transition-colors">
                  Enterprise
                </h3>
              ...
              <div className="mb-8">
                <div className="text-5xl font-bold text-gray-900 group-hover:text-white transition-colors">
                  Custom
                </div>
                <p className="text-gray-500 group-hover:text-white text-lg mt-2 transition-colors duration-300">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="text-left py-6 px-4 text-lg font-bold text-gray-900">
                    Features
                  </th>
                  <th className="text-center py-6 px-4 text-lg font-bold text-gray-900">
                    Free
                  </th>
                  <th className="text-center py-6 px-4 text-lg font-bold text-emerald-600">
                    Pro
                  </th>
                  <th className="text-center py-6 px-4 text-lg font-bold text-gray-900">
                    Enterprise
          ...
          <div className="space-y-4">
            <div className="border-b-4 border-white pb-6">
              ...
              >
                ...
                <ChevronDown
                  className={`w-8 h-8 text-white flex-shrink-0 transition-transform duration-300 ${openFaq === 0 ? "rotate-180" : ""}`}
                  strokeWidth={3}
                />
              </button>
              {openFaq === 0 && (
                <p className="mt-4 text-lg text-white/90 leading-relaxed">
                  ...
                  downgrading, changes take effect at the end of your current
                  billing cycle.
                </p>
              )}
            </div>
            ...
            <div className="border-b-4 border-white pb-6">
              ...
              >
                ...
                <ChevronDown
                  className={`w-8 h-8 text-white flex-shrink-0 transition-transform duration-300 ${openFaq === 1 ? "rotate-180" : ""}`}
                  strokeWidth={3}
                />
              </button>
              {openFaq === 1 && (
                <p className="mt-4 text-lg text-white/90 leading-relaxed">
                  We offer a 7-day money-back guarantee on all paid plans. If
                  you're not satisfied within the first 7 days, contact our
                  support team for a full refund, no questions asked.
                </p>
              )}
            </div>
            ...
            <div className="border-b-4 border-white pb-6">
              ...
              >
                ...
                <ChevronDown
                  className={`w-8 h-8 text-white flex-shrink-0 transition-transform duration-300 ${openFaq === 2 ? "rotate-180" : ""}`}
                  strokeWidth={3}
                />
              </button>
              {openFaq === 2 && (
                <p className="mt-4 text-lg text-white/90 leading-relaxed">
                  ...
                  Express), debit cards, UPI, net banking, and digital wallets.
                  All payments are processed securely through industry-standard
                  encryption.
                </p>
              )}
            </div>
            ...
            <div className="border-b-4 border-white pb-6">
              ...
              >
                ...
                <ChevronDown
                  className={`w-8 h-8 text-white flex-shrink-0 transition-transform duration-300 ${openFaq === 3 ? "rotate-180" : ""}`}
                  strokeWidth={3}
                />
              </button>
              {openFaq === 3 && (
                <p className="mt-4 text-lg text-white/90 leading-relaxed">
                  Yes! The 7-day free trial for the Pro plan requires no credit
                  card. You'll have full access to all Pro features during the
                  trial. After 7 days, you can choose to upgrade or continue
                  with the free plan.
                </p>
              )}
            </div>
            ...
            <div className="border-b-4 border-white pb-6">
              ...
              >
                ...
                <ChevronDown
                  className={`w-8 h-8 text-white flex-shrink-0 transition-transform duration-300 ${openFaq === 4 ? "rotate-180" : ""}`}
                  strokeWidth={3}
                />
              </button>
              {openFaq === 4 && (
                <p className="mt-4 text-lg text-white/90 leading-relaxed">
                  Enterprise pricing is customized based on your team size,
                  usage requirements, and specific needs. Contact our sales team
                  for a tailored quote. We offer volume discounts for larger
                  organizations.
                </p>
              )}
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">
              Trusted by <span className="text-emerald-500">5,000+</span> Job
              Seekers
            </h2>
            <p className="text-xl text-gray-600">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="flex-1">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Ready to{" "}
                <span className="bg-emerald-500 px-3 py-1 rounded">ace</span>{" "}
                your
                <br />
                next interview?
              </h2>
            ...
            <div className="flex-shrink-0">
              <button
                onClick={() => navigate("/register")}
                className="px-8 py-4 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 font-semibold text-lg flex items-center gap-2 shadow-lg"
              >
