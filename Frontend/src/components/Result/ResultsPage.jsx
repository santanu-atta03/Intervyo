...
const ResultsPage = ({ interviewId, result, navigate }) => {
              ...
              questionEvaluations: [
                {
                  ...
                  score: 8,
                  feedback:
                    "Good explanation! You could add examples of practical use cases.",
                },
                {
                  question: "Describe a challenging project you worked on",
                  answer:
                    "I worked on a real-time chat application with WebSocket implementation...",
                  category: "behavioral",
                  score: 7,
                  feedback:
                    "Good example with clear description of your role and challenges.",
                },
              ],
            },
            feedback: {
              ...
              summary:
                "Great job completing the interview! You demonstrated strong technical knowledge and good communication skills. Your problem-solving approach was logical and well-structured.",
              strengths: [
  ...
  const getPerformanceLevel = (score) => {
    ...
    if (score >= 60)
      return { text: "Good", emoji: "👍", color: "text-blue-400" };
    if (score >= 40)
      return { text: "Average", emoji: "📈", color: "text-yellow-400" };
          ...
          <div className="mb-8 sm:mb-12 text-center">
            <div className="inline-block relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <div
                  className={`text-2xl sm:text-3xl font-bold ${performance.color} flex items-center gap-2`}
                >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
                  {feedback?.summary ||
                    "Great job completing the interview! You demonstrated strong communication skills and technical knowledge."}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-700 rounded-full h-2 sm:h-3 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(feedback?.communicationScore || 0) * 10}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50">
              ...
              <div className="w-full bg-gray-700 rounded-full h-2 sm:h-3 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(feedback?.problemSolvingScore || 0) * 10}%`,
                  }}
                ></div>
              </div>
            </div>
                        ...
                        <span
                          className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold ${
                            evaluation.category === "technical"
                              ...
                              : evaluation.category === "behavioral"
                                ? "bg-green-500/20 text-green-400"
                                : evaluation.category === "coding"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-gray-900/50 rounded-xl p-4 sm:p-6 text-center">
                ...
                <p className="text-gray-400 text-xs sm:text-sm">
                  Continue building your skills with practice
                </p>
              </div>
              <div className="bg-gray-900/50 rounded-xl p-4 sm:p-6 text-center">
                <div className="text-3xl sm:text-4xl mb-2 sm:mb-3">🎯</div>
                ...
                <p className="text-gray-400 text-xs sm:text-sm">
                  Take more interviews to improve
                </p>
              </div>
              <div className="bg-gray-900/50 rounded-xl p-4 sm:p-6 text-center">
                <div className="text-3xl sm:text-4xl mb-2 sm:mb-3">💼</div>
                ...
                <p className="text-gray-400 text-xs sm:text-sm">
                  Use feedback in real interviews
                </p>
              </div>
            </div>
          </div>
