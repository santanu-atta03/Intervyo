  ...
  const fetchTopicData = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/learning-hub/topics/${topicId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
                  ...
                  <div className="flex items-center gap-6 mt-4 text-sm text-gray-400">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        ...
                        {(userProgress.totalTimeSpent || 0) % 60}m invested
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-700/50 hover:bg-gray-700 text-white py-3 rounded-xl font-semibold transition flex items-center justify-center gap-2"
              >
                <Share2 className="w-5 h-5" />
                Share Course
              </button>
