...
router.post(
  "/:interviewId/start-conversation",
  aiLimiter,
  RealTimeAiInterviewController.startConversation,
);

// Ask next question in AI interview
router.post(
  "/:interviewId/ask-next-question",
  RealTimeAiInterviewController.askNextQuestion,
);

// Get real-time AI response during conversation
router.post(
  "/:interviewId/real-time-response",
  RealTimeAiInterviewController.getRealTimeResponse,
);

// Evaluate code submission
router.post(
  "/:interviewId/evaluate-code",
  RealTimeAiInterviewController.evaluateCode,
);

// Submit answer and move to next question
router.post(
  "/:interviewId/submit-answer",
  RealTimeAiInterviewController.submitAnswer,
);
