...
export const AIContentCache = mongoose.model(
  "AIContentCache",
  ...
  const defaultTopics = [
    {
      ...
      description:
        "Master the core concepts of JavaScript including ES6+ features",
      domain: "Frontend",
      difficulty: "Beginner",
      icon: "⚡",
      estimatedHours: 15,
    ...
    },
    {
      ...
      description:
        "Build modern web applications with React, Hooks, and Context API",
      domain: "Frontend",
