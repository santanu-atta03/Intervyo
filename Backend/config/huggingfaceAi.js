  ...
  for (let attempt = 1; attempt <= retries; attempt++) {
    try {
      ...
      if (!response.ok) {
        ...
        console.error(
          `Hugging Face API error (attempt ${attempt}):`,
          response.status,
          errorText,
        );
        ...
        if (response.status === 404) {
          throw new Error(
            "Model not found. Please check your Hugging Face API configuration.",
          );
        }
...
function getDefaultQuestions(role, difficulty) {
  const questions = {
    easy: [
      {
        question: `Tell me about your experience with ${role} technologies.`,
        type: "technical",
        expectedAnswer: "Experience overview",
      },
      {
        question: "What interests you about this role?",
        type: "behavioral",
        expectedAnswer: "Motivation",
      },
      {
        question: "Describe a project you're proud of.",
        type: "behavioral",
        expectedAnswer: "Project details",
      },
      {
        question: "How do you stay updated with technology trends?",
        type: "technical",
        expectedAnswer: "Learning approach",
      },
      {
        question: "Write a function to reverse a string.",
        type: "coding",
        expectedAnswer: "Code solution",
      },
      {
      ...
      },
      {
        ...
        type: "behavioral",
        expectedAnswer: "Future plans",
      },
    ],
    medium: [
      {
        question: `Explain your understanding of ${role} best practices.`,
        type: "technical",
        expectedAnswer: "Best practices",
      },
      {
        question: "Tell me about a challenging bug you fixed.",
        type: "technical",
        expectedAnswer: "Problem solving",
      },
      {
        question: "How do you approach code reviews?",
        type: "behavioral",
        expectedAnswer: "Collaboration",
      },
      {
      ...
      },
      {
        ...
        type: "technical",
        expectedAnswer: "Git knowledge",
      },
      {
        question: "How do you handle disagreements in a team?",
        type: "behavioral",
        expectedAnswer: "Conflict resolution",
      },
      {
        question: "Explain a time you optimized code performance.",
        type: "technical",
        expectedAnswer: "Optimization skills",
      },
      {
        question: "What testing strategies do you use?",
        type: "technical",
        expectedAnswer: "Testing approach",
      },
      {
        question: "Implement a simple caching mechanism.",
        type: "coding",
        expectedAnswer: "Code solution",
      },
      {
        ...
        type: "behavioral",
        expectedAnswer: "Organization",
      },
    ],
    hard: [
      {
        question: `Design a scalable architecture for ${role} application.`,
        type: "technical",
        expectedAnswer: "System design",
      },
      {
        question: "Explain your approach to microservices.",
        type: "technical",
        expectedAnswer: "Architecture knowledge",
      },
      {
        question: "How do you ensure code quality at scale?",
        type: "technical",
        expectedAnswer: "Quality assurance",
      },
      {
      ...
      {
        question: "Describe a system you designed from scratch.",
        type: "technical",
        expectedAnswer: "Design experience",
      },
      {
        question: "How do you handle technical debt?",
        type: "behavioral",
        expectedAnswer: "Strategy",
      },
      {
        question: "Explain database optimization techniques you've used.",
        type: "technical",
        expectedAnswer: "DB knowledge",
      },
      {
      ...
      {
        question: "Write a thread-safe singleton pattern.",
        type: "coding",
        expectedAnswer: "Code solution",
      },
      {
        ...
        type: "behavioral",
        expectedAnswer: "Leadership",
      },
      {
        question: "Describe your CI/CD experience.",
        type: "technical",
        expectedAnswer: "DevOps knowledge",
      },
      {
        question: "How do you approach security in your code?",
        type: "technical",
        expectedAnswer: "Security practices",
      },
    ],
  };
